...
from pattern.vector import SVM, CLASSIFICATION, LINEAR, POLYNOMIAL
...
def get_pol_map():
	...
	d = open("../dictionaries/bow_map.txt")
	for elem in d:
...
def evaluate_bow_and_features(tweet):
	...
	conj_inverted = ['sino']
	conj_fol = ['al_contrario', 'no_obstante', 'aún', 'aun', 'todavía', 'todavia', 'más_bien', 'mas_bien']
	conj_prev = ['hasta', 'a_pesar_de', 'a_pesar', 'aunque', 'excepto', 'salvo', 'aún_asi', 'aun_asi', 'pero', 'sin_embargo']
	conj_infer = ['por_lo_tanto', 'además', 'ademas', 'en_consecuencia', 'por_tanto', 'como_resultado', 'posteriormente', 'por_eso']
...
def main():
	...
	svm_classifier = SVM(type=CLASSIFICATION, kernel=POLYNOMIAL)
